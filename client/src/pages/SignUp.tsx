    ...
    <main className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-background px-4 py-12 text-foreground">
      ...
      <div className="relative z-10 w-full max-w-sm">
          ...
          <form onSubmit={handleSubmit} noValidate className="space-y-4">
            ...
            <div className="space-y-1.5">
              ...
              <Input
                ...
                className={`border-white/15 bg-white/5 text-foreground placeholder:text-muted-foreground/50 focus-visible:ring-white/30 ${fieldErrors.name ? "border-destructive" : ""}`}
              />
        ...
        <p className="mt-6 text-center text-sm text-muted-foreground">
          ...
          <a href="/login" className="text-foreground underline underline-offset-2 hover:text-white">
            Log in
          </a>
        </p>
      </div>
