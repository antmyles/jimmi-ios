...
const termsSections = [
  ...
  },
  {
    ...
    body: "JIMMI uses automated AI systems to generate coaching, nutrition, and recovery-related content. AI output may be incomplete, inaccurate, or unsuitable for your individual circumstances. Nutrition estimates and macro calculations are approximations. You are responsible for reviewing recommendations and using your own judgment before acting on them.",
  },
  {
    title: "Your content",
  ...
  },
  {
    ...
    body: "JIMMI may connect with third-party services such as Oura, Fitbit, WHOOP. Your use of those integrations is subject to the respective provider's terms and privacy policies. JIMMI is not responsible for the practices of third-party services. You may revoke access at any time through your connected device's settings.",
  },
  {
    title: "Intellectual property",
    body: `JIMMI and its content, design, software, branding, and service materials are owned by ${OWNER_NAME} or its licensors. Subject to your compliance with these Terms, you may use the Service for your personal, non-commercial fitness and wellness purposes only.`,
  },
  {
    title: "Disclaimer of warranties",
    body: 'JIMMI is provided "as is" and "as available" without warranties of any kind, express or implied. We do not warrant that the Service will be uninterrupted, error-free, or completely accurate.',
  },
  {
  ...
  return (
    <main className="min-h-screen bg-background text-foreground">
      <section className="relative overflow-hidden border-b border-white/10 bg-black">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_76%_12%,rgba(216,199,163,0.16),transparent_34%),radial-gradient(circle_at_12%_44%,rgba(143,232,216,0.12),transparent_30%)]" aria-hidden="true" />
        <div className="container relative z-10 px-5 py-6 sm:px-8 lg:px-10">
          ...
          <div className="max-w-3xl py-16 sm:py-20">
            <p className="font-mono text-xs uppercase tracking-[0.34em] text-[#d8c7a3]">Legal</p>
        ...
        <div className="grid gap-5 lg:grid-cols-[0.72fr_1.28fr]">
          <aside className="rounded-[1.5rem] border border-white/10 bg-white/[0.035] p-5 text-sm leading-6 text-white/60 lg:sticky lg:top-6 lg:self-start">
            ...
            <p className="mt-3">
              ...
              <a className="text-[#d8c7a3] underline-offset-4 hover:underline" href={`mailto:${CONTACT_EMAIL}`}>
                {CONTACT_EMAIL}
              </a>.
            </p>
            ...
            <div className="mt-6 border-t border-white/10 pt-4">
              <a className="text-[#d8c7a3] text-xs underline-offset-4 hover:underline" href="/privacy">
                View Privacy Policy →
              </a>
            </div>
          </aside>
          ...
          <div className="space-y-4">
            ...
            <article className="rounded-[1.5rem] border border-[#d8c7a3]/20 bg-[#d8c7a3]/[0.055] p-6">
